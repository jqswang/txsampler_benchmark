...
#ifdef PARALLEL
#ifdef RTM
TM_LOCK_T mutex_decompress = TM_LOCK_INITIALIZER,
  mutex_checkcache = TM_LOCK_INITIALIZER,
  mutex_reassemble = TM_LOCK_INITIALIZER,
  mutex_end_decompress = TM_LOCK_INITIALIZER,
  mutex_end_checkcache = TM_LOCK_INITIALIZER,
  mutex_end_recvblock = TM_LOCK_INITIALIZER;
#else
