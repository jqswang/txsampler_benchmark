...
#ifdef RTM
//It seems that TrySet() is not used. So we are not going to implement it
#else
...
#ifdef RTM
//It seems that TryGet() is not used. So we are not going to implement it
#else
...
#ifdef RTM
//It seems that TrySwap() is not used. So we are not going to implement it
#else
...
#ifdef RTM
//It seems that Checkout(), TryCheckout() and Checkin() are not used. So we are not going to implement it
#else
